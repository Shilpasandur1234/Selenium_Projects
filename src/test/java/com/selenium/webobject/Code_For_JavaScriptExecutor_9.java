...
public class Code_For_JavaScriptExecutor_9 {
	...
	public void Code_For_JavaScriptExecutor_Test() throws Exception {
		...
		WebElement firstName = w.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[1]/div[1]/input"));
		WebElement lastName = w.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[1]/div[2]/input"));
		...
		WebElement thai=w.findElement(By.xpath("//*[@id=\"msdd\"]"));
